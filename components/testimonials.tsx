const testimonials = [
  ...
  {
    name: "Carolina M.",
    text: "Já sou cliente há mais de um ano. Os tratamentos fizeram uma diferença enorme na minha pele.",
    service: "Estética Facial",
  },
  {
    name: "Fernanda T.",
    text: "Design de sobrancelha impecável! Finalmente encontrei alguém que entende o formato certo para o meu rosto.",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="bg-card rounded-2xl p-6 border border-border hover:border-primary/25 hover:shadow-md transition-all duration-300 flex flex-col"
            >
              <Stars />
